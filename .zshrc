...
# Add aliases
alias lg='lazygit'
alias gg='nono run --profile pi pi --system-prompt "none" --append-system-prompt "none" --model lmstudio/google/gemma-4-26b-a4b:off -ne -e ~/.pi/agent/extensions/herdr-agent-state.ts'
