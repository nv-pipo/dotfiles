...
# Add aliases
alias lg='lazygit'
alias gg='nono run --profile pi pi --system-prompt "none" --append-system-prompt "none" --model lmstudio/ornith-1.0-35b:off -ne -e ~/.pi/agent/extensions/herdr-agent-state.ts'
